...
let CONFIG = {
    ...
    urlMaestros: 'https://script.google.com/macros/s/AKfycbxTKAwY9m_AuxV-d9IsOaa_IDv1ZAvWv26RdgiIzD2Y6ucX_CtKVjrWbnR5Fefd12uV/exec',
     // 👉 URL de Maestros
    urlNootificaciones: 'https://script.google.com/macros/s/AKfycbxza27B1vj81BpWe_8qrsQusxE0YC2FzoY1j4yAKkG3uq89gA1xIljm3PuWCQljJojZ2Q/exec'
};
...
function mostrarNotificaciones(filtro = 'todas') {
    ...
    notifsFiltradas.forEach(notif => {
        const tiempoTexto = obtenerTiempoRelativo(notif.timestamp);
...
function generarNotificacionesAutomaticas() {
    ...
    // 2. Reuniones programadas para hoy
    const reunionesHoy = datosReuniones.filter(r => {
