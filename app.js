...
async function cargarDatosDesdeGoogleSheets(url) {
    ...
    try {
        // Usar fetch simple - Apps Script acepta GET sin problemas
            ...
            <form id="formIncidencia" onsubmit="registrarIncidencia(event)">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select id="tipoConducta" required>
                            ...
                            <option value="Salida del centro sin autorización">Salida del centro sin autorización</option>
                ...
                <div class="form-group">
                    ...
                    <div id="accionesSeguimientoPanel" style="border:1px solid #d1d5db;border-radius:8px;margin-bottom:8px;background:white;overflow:hidden;">
                        ...
                        <div id="accionesDropdown" style="display:none;max-height:360px;overflow-y:auto;padding:12px 16px;box-sizing:border-box;">
                            ...
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Recibí el reporte de la falta de parte de un docente, directivo o miembro de la comunidad educativa." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Recibí el reporte de la falta de parte de un docente, directivo o miembro de la comunidad educativa.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Clasifiqué la falta según el Manual de Convivencia: leve, grave o muy grave." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Clasifiqué la falta según el Manual de Convivencia: leve, grave o muy grave.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Abrí o actualicé el expediente disciplinario del estudiante, registrando fecha, descripción de los hechos y quien reportó." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Abrí o actualicé el expediente disciplinario del estudiante, registrando fecha, descripción de los hechos y quien reportó.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Verifiqué si el estudiante tenía antecedentes disciplinarios previos que lo clasificaran como reincidente." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Verifiqué si el estudiante tenía antecedentes disciplinarios previos que lo clasificaran como reincidente.</label>
                            ...
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Cité por escrito a los padres, madres o tutores del estudiante para informarles formalmente de los hechos." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Cité por escrito a los padres, madres o tutores del estudiante para informarles formalmente de los hechos.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Notifiqué de forma confidencial a los representantes legales del estudiante afectado, en los casos que involucraron una víctima." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Notifiqué de forma confidencial a los representantes legales del estudiante afectado, en los casos que involucraron una víctima.</label>
                            ...
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Sostuve un diálogo reflexivo con el estudiante, permitiéndole presentar su versión de los hechos." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Sostuve un diálogo reflexivo con el estudiante, permitiéndole presentar su versión de los hechos.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Escuché sus descargos antes de aplicar cualquier medida correctiva o sanción." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Escuché sus descargos antes de aplicar cualquier medida correctiva o sanción.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Orienté al estudiante sobre las normas que incumplió, los artículos del Manual de Convivencia que aplican y las consecuencias de su conducta." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Orienté al estudiante sobre las normas que incumplió, los artículos del Manual de Convivencia que aplican y las consecuencias de su conducta.</label>
                            ...
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Apliqué la medida correctiva o sanción correspondiente al tipo de falta, conforme a los artículos 38, 43 y 48 del Manual de Convivencia." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Apliqué la medida correctiva o sanción correspondiente al tipo de falta, conforme a los artículos 38, 43 y 48 del Manual de Convivencia.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Escalé la sanción conforme a los artículos 39 y 44, en los casos donde se identificó reincidencia." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Escalé la sanción conforme a los artículos 39 y 44, en los casos donde se identificó reincidencia.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Documenté la sanción aplicada con todos sus detalles en el expediente del estudiante." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Documenté la sanción aplicada con todos sus detalles en el expediente del estudiante.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Obtuve la firma del estudiante y sus representantes como constancia de notificación y conocimiento de la sanción." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Obtuve la firma del estudiante y sus representantes como constancia de notificación y conocimiento de la sanción.</label>
                            ...
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Establecí acuerdos concretos y verificables de mejora de conducta con el estudiante y su familia." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Establecí acuerdos concretos y verificables de mejora de conducta con el estudiante y su familia.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Fijé plazos de evaluación de dichos compromisos, vinculados al cierre de cada período escolar." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Fijé plazos de evaluación de dichos compromisos, vinculados al cierre de cada período escolar.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Registré todos los acuerdos y firmas en el expediente disciplinario." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Registré todos los acuerdos y firmas en el expediente disciplinario.</label>
                            ...
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Remití al estudiante al Departamento de Orientación y Psicología cuando la falta lo ameritó." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Remití al estudiante al Departamento de Orientación y Psicología cuando la falta lo ameritó.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Garanticé atención psicológica prioritaria al estudiante afectado en los casos que involucraron una víctima." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Garanticé atención psicológica prioritaria al estudiante afectado en los casos que involucraron una víctima.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Coordiné con los docentes el seguimiento académico del estudiante durante el proceso disciplinario." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Coordiné con los docentes el seguimiento académico del estudiante durante el proceso disciplinario.</label>
                            ...
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Informé por escrito a la Dirección del Centro de todas las sanciones por faltas graves y muy graves." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Informé por escrito a la Dirección del Centro de todas las sanciones por faltas graves y muy graves.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Notifiqué al Departamento de Atención a la Diversidad del Distrito Educativo con copia al Director(a), en los casos que así lo requirieron, conforme al Art. 52." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Notifiqué al Departamento de Atención a la Diversidad del Distrito Educativo con copia al Director(a), en los casos que así lo requirieron, conforme al Art. 52.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Informé a la Dirección sobre la pertinencia de activar mecanismos legales bajo la Ley 136-03, en los casos que pudieron constituir ilícitos penales." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Informé a la Dirección sobre la pertinencia de activar mecanismos legales bajo la Ley 136-03, en los casos que pudieron constituir ilícitos penales.</label>
                            ...
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Monitoreé el comportamiento del estudiante durante las semanas siguientes a la sanción." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Monitoreé el comportamiento del estudiante durante las semanas siguientes a la sanción.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Evalué al cierre de cada período el cumplimiento de los compromisos establecidos." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Evalué al cierre de cada período el cumplimiento de los compromisos establecidos.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Escalé las medidas y convoqué nuevamente a la familia en los casos donde se identificó incumplimiento." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Escalé las medidas y convoqué nuevamente a la familia en los casos donde se identificó incumplimiento.</label>
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" value="Cerré el caso en el expediente una vez verificada la mejora de conducta, dejando constancia escrita de dicho cierre." style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;"> Cerré el caso en el expediente una vez verificada la mejora de conducta, dejando constancia escrita de dicho cierre.</label>
                            ...
                            <label style="display:grid;grid-template-columns:18px 1fr;gap:8px;padding:5px 2px;cursor:pointer;font-size:0.88em;font-weight:normal;line-height:1.4;width:100%;box-sizing:border-box;"><input type="checkbox" class="accion-check" id="checkOtros" value="__otros__" style="width:16px;height:16px;margin:0;margin-top:2px;accent-color:#1e3a5f;cursor:pointer;flex-shrink:0;" onchange="toggleOtrosInput(this)"> Otra acción no listada (especificar abajo)</label>
...
function exportarTardanzasPDF() {
    ...
    if (filtroTardanzas === 'mas10') {
        ...
        doc.autoTable({
            startY: startY,
            head: [['#', 'Estudiante', 'Curso', 'Total Acumulado', 'Nota']],
            body: conMas10.map((e, i) => [
                i + 1,
                e.estudiante,
                e.curso,
                e.total,
                ['6toA','6toB','6toC'].includes(e.curso) ? 'No aplica' : ''
            ]),
            theme: 'grid',
            ...
            columnStyles: {
                ...
                4: { cellWidth: 30, halign: 'center', fontStyle: 'italic', textColor: [107, 114, 128] }
            }
        });
...
function buscarReuniones() {
    ...
    tbody.innerHTML = filtrados.map((r) => {
        // Encontrar el índice REAL en el array original datosReuniones
        ...
        // Calcular número de reunión en orden cronológico usando el array ORIGINAL
        const reunionesEstudiante = datosReuniones
            .filter(reunion => {
                const est = reunion['Nombre Estudiante'] || reunion.estudiante || '';
                return est.toLowerCase() === estudiante.toLowerCase();
...
// SISTEMA DE NOTIFICACIONES
// ========================================
// NOTA: El sistema de notificaciones ahora está implementado en notificaciones-sheets.js
// Este archivo solo mantiene las funciones auxiliares necesarias
